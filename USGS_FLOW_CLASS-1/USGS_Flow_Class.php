                    ...
                    <table id="FlowTable" class="tablesorter" style="line-height: 15px;" border="1"> 
                        ...
                        $rate['change'] = $this->formatNum($rate['change']);
                            ...
                            if($rate['latestlevel'] == -999999){ $html .='<td>
                                                <span style="font-size:0; visibility:hidden">4-</span><a href="#0" title="Sync Disabled"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    <g class="nc-icon-wrapper" fill="#35485d">
